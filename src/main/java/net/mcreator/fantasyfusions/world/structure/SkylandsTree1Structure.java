...
public class SkylandsTree1Structure extends FantasyFusionsModElements.ModElement {
	public SkylandsTree1Structure(FantasyFusionsModElements instance) {
		super(instance, 64);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 990000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("fantasy_fusions", "skylandstree1"));
						if (template == null)
							return false;
