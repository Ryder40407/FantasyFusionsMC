...
public class SkylandsTree3Structure extends FantasyFusionsModElements.ModElement {
	public SkylandsTree3Structure(FantasyFusionsModElements instance) {
		super(instance, 66);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 990000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("fantasy_fusions", "skylandstree3"));
						if (template == null)
							return false;
