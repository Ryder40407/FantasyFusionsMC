...
public class SkylandsBush1Structure extends FantasyFusionsModElements.ModElement {
	public SkylandsBush1Structure(FantasyFusionsModElements instance) {
		super(instance, 63);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 950000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("fantasy_fusions", "skylandsbush1"));
						if (template == null)
							return false;
