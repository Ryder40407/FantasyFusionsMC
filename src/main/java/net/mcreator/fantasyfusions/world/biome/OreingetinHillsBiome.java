...
public class OreingetinHillsBiome extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:oreingetin_hills")
	public static final CustomBiome biome = null;
	public OreingetinHillsBiome(FantasyFusionsModElements instance) {
		super(instance, 102);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		BiomeDictionary.addTypes(biome, BiomeDictionary.Type.SPARSE, BiomeDictionary.Type.SAVANNA, BiomeDictionary.Type.MOUNTAIN);
		BiomeManager.addSpawnBiome(biome);
		BiomeManager.addBiome(BiomeManager.BiomeType.WARM, new BiomeManager.BiomeEntry(biome, 12));
	}
	static class CustomBiome extends Biome {
		public CustomBiome() {
			super(new Biome.Builder().downfall(0.7000000000000001f).depth(0.5f).scale(0.7f).temperature(0.5f).precipitation(Biome.RainType.RAIN)
					.category(Biome.Category.SAVANNA).waterColor(-26368).waterFogColor(-26368).parent("fantasy_fusions:oreingetin_forest")
					.surfaceBuilder(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(Blocks.GRASS_BLOCK.getDefaultState(),
							Blocks.DIRT.getDefaultState(), Blocks.DIRT.getDefaultState())));
			setRegistryName("oreingetin_hills");
			...
			addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.RANDOM_PATCH.withConfiguration(DefaultBiomeFeatures.GRASS_CONFIG)
					.withPlacement(Placement.COUNT_HEIGHTMAP_DOUBLE.configure(new FrequencyConfig(21))));
