...
public class TrikiteSwordItem extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:trikite_sword")
	public static final Item block = null;
	public TrikiteSwordItem(FantasyFusionsModElements instance) {
		super(instance, 88);
	}
