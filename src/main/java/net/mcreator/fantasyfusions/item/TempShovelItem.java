...
public class TempShovelItem extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:temp_shovel")
	public static final Item block = null;
	public TempShovelItem(FantasyFusionsModElements instance) {
		super(instance, 31);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ShovelItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("TempShovel"));
			}
