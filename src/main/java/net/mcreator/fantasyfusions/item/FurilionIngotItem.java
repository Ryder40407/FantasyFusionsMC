...
public class FurilionIngotItem extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:furilion_ingot")
	public static final Item block = null;
	public FurilionIngotItem(FantasyFusionsModElements instance) {
		super(instance, 15);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("furilion_ingot");
		}
