...
public class SilvikeHoeItem extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:silvike_hoe")
	public static final Item block = null;
	public SilvikeHoeItem(FantasyFusionsModElements instance) {
		super(instance, 78);
	}
