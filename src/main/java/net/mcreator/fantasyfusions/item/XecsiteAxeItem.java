...
public class XecsiteAxeItem extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:xecsite_axe")
	public static final Item block = null;
	public XecsiteAxeItem(FantasyFusionsModElements instance) {
		super(instance, 52);
	}
