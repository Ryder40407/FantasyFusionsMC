...
public class WauviunCrystalItem extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:wauviun_crystal")
	public static final Item block = null;
	public WauviunCrystalItem(FantasyFusionsModElements instance) {
		super(instance, 22);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("wauviun_crystal");
		}
