...
public class TrikiteHoeItem extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:trikite_hoe")
	public static final Item block = null;
	public TrikiteHoeItem(FantasyFusionsModElements instance) {
		super(instance, 90);
	}
