...
public class TrikiteIngotItem extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:trikite_ingot")
	public static final Item block = null;
	public TrikiteIngotItem(FantasyFusionsModElements instance) {
		super(instance, 74);
	}
