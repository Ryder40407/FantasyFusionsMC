...
public class FraothilIngotItem extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:fraothil_ingot")
	public static final Item block = null;
	public FraothilIngotItem(FantasyFusionsModElements instance) {
		super(instance, 16);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fraothil_ingot");
		}
