...
public class FlorithiteIngotItem extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:florithite_ingot")
	public static final Item block = null;
	public FlorithiteIngotItem(FantasyFusionsModElements instance) {
		super(instance, 57);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("florithite_ingot");
		}
