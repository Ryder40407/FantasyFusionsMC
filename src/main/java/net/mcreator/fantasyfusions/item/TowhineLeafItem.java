...
public class TowhineLeafItem extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:towhine_leaf")
	public static final Item block = null;
	public TowhineLeafItem(FantasyFusionsModElements instance) {
		super(instance, 20);
	}
