...
public class XecsiteIngotItem extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:xecsite_ingot")
	public static final Item block = null;
	public XecsiteIngotItem(FantasyFusionsModElements instance) {
		super(instance, 17);
	}
