...
public class TowhineOreJungleBlock extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:towhine_ore_jungle")
	public static final Block block = null;
	public TowhineOreJungleBlock(FantasyFusionsModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("towhine_ore_jungle");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TowhineLeafItem.block, (int) (2)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("towhine_ore_jungle", "towhine_ore_jungle", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == TowhineOreJungleBlock.block.getDefaultState().getBlock())
					blockCriteria = true;
