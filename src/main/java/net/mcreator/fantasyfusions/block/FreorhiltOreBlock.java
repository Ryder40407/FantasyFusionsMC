...
public class FreorhiltOreBlock extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:freorhilt_ore")
	public static final Block block = null;
	public FreorhiltOreBlock(FantasyFusionsModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(2f, 2f).lightValue(0).harvestLevel(1)
					.harvestTool(ToolType.SHOVEL));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("freorhilt_ore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("freorhilt_ore", "freorhilt_ore", blockAt -> {
			...
			}), block.getDefaultState(), 7)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(20, 50, 50, 75))));
		}
	}
}
