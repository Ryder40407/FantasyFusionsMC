...
public class TowhineOreOakBlock extends FantasyFusionsModElements.ModElement {
	@ObjectHolder("fantasy_fusions:towhine_ore_oak")
	public static final Block block = null;
	public TowhineOreOakBlock(FantasyFusionsModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("towhine_ore_oak");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("towhine_ore_oak", "towhine_ore_oak", blockAt -> {
